...
export default async function LandingPage() {
  ...
  const navItems = [
    ...
    { label: "Readiness Model", href: "#assessment" },
  ...
  return (
    <div className="min-h-screen bg-transparent text-text-primary tech-grid selection:bg-primary/30 selection:text-text-primary flex flex-col justify-between">
      ...
      <header className="border-b border-border/80 sticky top-0 z-50 bg-base/80 backdrop-blur-md w-full">
        <div className="container-fluid h-16 flex items-center justify-between">
          <div className="flex items-center space-x-3">
            ...
            <span className="font-bold text-title-md tracking-tight">Placement OS</span>
          </div>
      ...
      {/* Hero Section */}
      <section className="pt-16 pb-16 container-fluid text-center">
        ...
        <div className="mt-16 p-3 rounded-xl bg-gradient-to-b from-border/50 via-border/20 to-transparent border border-border/60 shadow-2xl">
          <div className="rounded-lg bg-surface border border-border/80 p-6 md:p-8 text-left relative overflow-hidden">
            ...
            <div className="flex items-center justify-between pb-6 border-b border-border mb-6">
              <div className="flex items-center gap-2">
                ...
                <span className="text-label-xs text-text-muted ml-3 font-mono">placement-os-v1.0.app</span>
              </div>
      ...
      <section id="features" className="py-20 container-fluid border-t border-border/80">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 w-full">
          ...
          {/* Card 5: Placement Tests */}
          <div className="bg-surface/80 backdrop-blur-md border border-border/80 rounded-xl p-8 flex flex-col justify-between hover:border-primary/50 transition-all duration-300 shadow-lg hover:shadow-primary/5 lg:col-span-2">
            <div>
              <div className="w-12 h-12 rounded-lg bg-primary/10 flex items-center justify-center text-primary-text mb-6">
              ...
              <p className="text-body-sm text-text-secondary mb-8 max-w-2xl leading-relaxed">
                Curated mock tests covering Aptitude, CS Fundamentals, and Full-Stack Placement rounds designed to simulate exact interview environments.
              </p>
            </div>
            <div className="pt-6 border-t border-border/60 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
              <span className="text-label-xs text-text-muted font-mono tracking-wider">
                4 READY TESTS • 130+ CURATED QUESTIONS
              </span>
              <Link
                href="/tests"
